...
import jittor as jt
from j_nerf.Method.global_vars import global_headers, proj_options
...
class CalcRgb(Function):
    ...
    def execute(
        ...
        linear_kernel(compute_rgbs<grad_t>, 0,stream,
            ...
            PitchedPtr<NerfCoordinate>((NerfCoordinate*)coords_in_p, 1, 0, 0),(uint32_t*)rays_numsteps_p,(Array3f*)rgb_output_p,
...
""",
    ...
    def inference(self, network_output, coords_in, rays_numsteps, density_grid_mean):
        ...
        linear_kernel(compute_rgbs_inference<grad_t>, 0, stream,
            n_rays, m_aabb,padded_output_width,bg_color,(grad_t*)network_output_p,rgb_activation,density_activation,
            PitchedPtr<NerfCoordinate>((NerfCoordinate*)coords_in_p, 1, 0, 0),(uint32_t*)rays_numsteps_p,(Array3f*)rgb_output_p,
            NERF_CASCADES(),MIN_CONE_STEPSIZE(),alpha_output_p);      
""",
        )
