...
from j_nerf.Config.key import BASE_KEY, COVER_KEY
from j_nerf.Method.general import check_file
        ...
        if BASE_KEY in cfg:
            ...
            for bfn in base_filenames:
                Config.merge_dict_b2a(
                    cfg_base, Config._load_dict_from_file(os.path.join(cfg_dir, bfn))
                )
            cfg.pop(BASE_KEY)
