import os
from math import ceil, exp, log, log2, pow
...
""",
    ...
    def grad(self, grad_x):
        self.m_grid_gradient, self.m_encoded_positions = jt.code(
            [self.m_positions, self.m_hashmap_offsets_table, grad_x],
